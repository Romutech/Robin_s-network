# Generated by Django 4.0 on 2021-12-30 01:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='ProfilePicture',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='profile_picture', serialize=False, to='auth.user')),
